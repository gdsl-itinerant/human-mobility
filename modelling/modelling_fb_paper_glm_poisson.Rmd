...
for (i in 1:18){
  ...
  coefficients_t<-coefficients_df %>%
    ...
    mutate(
     ci_lower = estimate - ( 2.57 * std_error ),
     ci_upper = estimate + ( 2.57 * std_error )
     )
...
diagnostics %>%
  ...
  kbl(caption="Poisson Regression Monthly Models Diagnostics.",
       format= "latex",
   col.names = c("Month-Year","Residual Deviance","Chi Square Test","Akaike","Pseudo R squared","Number of Obs.","Degrees of Freedom","Log-Likelihood"),
                  align="r") %>%

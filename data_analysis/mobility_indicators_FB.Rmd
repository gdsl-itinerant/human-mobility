...
files<-list.files("~/itinerant/pre-processed-movements/exploration/selected_dates",full.names = T) ###files of the two months have been manually moved to a specific folder to speed the processing up
...
out
ggsave("~/itinerant/img/class_analysis/outflows.jpeg")


inf<-ggplot(inflows,aes(x=destination_class,y=(ratio-1)*100, color=destination_class,fill=destination_class,group=destination_class))+
  geom_boxplot(varwidth = TRUE,alpha=0.2)+
  scale_fill_viridis_d()+
  scale_color_viridis_d()+
  theme_bw()+
  ...
  facet_wrap(~time_interval)
inf
ggsave("~/itinerant/img/class_analysis/inflows.jpeg")

intra<-ggplot(intraMov,aes(x=destination_class,y=(ratio-1)*100, color=destination_class,fill=destination_class,group=destination_class))+
  geom_boxplot(varwidth = TRUE,alpha=0.2)+
  scale_fill_viridis_d()+
  scale_color_viridis_d()+
  theme_bw()+
...
intra
ggsave("~/itinerant/img/class_analysis/intra.jpeg")
```
